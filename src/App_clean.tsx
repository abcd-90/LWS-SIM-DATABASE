  ...
  const downloadPDF = async () => {
    ...
    try {
      ...
      results.forEach((res, index) => {
        ...
        pdf.text('INTELLIGENCE & INVESTIGATION DIVISION ΓÇó PAKISTAN CRIME REGISTRY', 15, 30);
        ...
        // Sami Signature
        const signatureBase64 = "data:image/png;base64,";
  ...
  const copyToClipboard = () => {
    ...
    const shareOnWhatsApp = () => {
      const text = `*${appConfig.toolName} - Record Analysis*\n\n` +
        `≡ƒæñ *Name:* ${data.name || data.full_name}\n` +
        `≡ƒô▒ *Mobile:* ${data.phone || data.mobile}\n` +
        `≡ƒåö *CNIC:* ${data.cnic || data.nic}\n` +
        `≡ƒÅá *Address:* ${data.address || 'N/A'}\n` +
        `≡ƒôì *Network:* ${data.network || data.operator || 'N/A'}\n\n` +
        `≡ƒöù *Generated by:* ${window.location.host}`;
